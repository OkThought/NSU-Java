...
public class FilterTest {
    ...
    Filter timeFilter0 = new ModifiedLaterFilter(1);
    Filter timeFilter1 = new ModifiedLaterFilter(1);
    Filter timeFilter2 = new ModifiedLaterFilter(2);
    Filter timeFilter3 = new ModifiedEarlierFilter(1);
    Filter timeFilter4 = new ModifiedEarlierFilter(2);
